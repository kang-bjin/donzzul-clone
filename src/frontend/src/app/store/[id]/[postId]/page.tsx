...
const dummyComments: Comment[] = [
  { id: 1, author: '여름이야', text: '우와~~ 성심당 여기 유명하죠 근데 저는 솔직히 튀김 소보루보다 튀소구마가 더 맛있는 듯!!', date: '1시간 전', avatarUrl: '/햄스터_깜짝.jpg' },
    ...
    <>
      ...
      <main className="min-h-screen px-4 bg-white overflow-y-auto">
        <div className="flex items-center gap-3 py-2 mb-3">
          ...
          />
          <span className="font-bold">리뷰페이지</span>
        </div>
        {/* ★ 작성자 프로필 영역 추가 ★ */}
