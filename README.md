...
## 🚀️ 강병진(kang-bjin) - 기획/백엔드/기술 리드
- 아이디어 제안, 서비스 철학과 초기 방향성 기획, 구조 설계 주도
- 기술적 리더로서 스프링 MVC, 인증, JPA 등 주요 기술 도입 · 공유 및 Notion 협업 문서 관리
- 사용자 인증, 제보-투표-등록-기부 등 백엔드 및 DB 전담 구현
- 영상처리 기술을 이용한 영수증 이미지 전처리 및 인증 파이프라인 전담 구축
- 역할 분배, 개발 경험이 부족한 팀원 교육, 기능 우선순위 조율 등 협업 과정 전반 리드
- 최종 발표 및 질의응답을 주도하며 프로젝트 전반을 책임지고 마무리

<details>
<summary> ▶️ 전체 기여내용 </summary>
